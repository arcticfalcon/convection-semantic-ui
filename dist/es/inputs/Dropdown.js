...
var DropdownInput = (0, _mobxReact.observer)(function (_ref) {
  var label = _ref.label,
      ...
      width = _ref.width,
      otherProps = _objectWithoutProperties(_ref, ['label', 'path', 'model', 'getter', 'getErrors', 'hasErrors', 'handleChange', 'defaultValue', 'dynamicProps', 'options', 'inline', 'required', 'width']);
...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(DropdownInput, 'DropdownInput', 'src/inputs/Dropdown.jsx');

  __REACT_HOT_LOADER__.register(_default, 'default', 'src/inputs/Dropdown.jsx');
}();
